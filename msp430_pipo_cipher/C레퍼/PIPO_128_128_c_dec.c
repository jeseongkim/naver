...
void Key_XOR_128_128(uint16_t In_text[], uint16_t Key[], uint16_t Round);
void PIPO_128_128_D_C(uint8_t Plaintext[], uint8_t Key[], uint8_t Ciphertext[]);
//#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-
...
void PIPO_128_128_D_C(uint16_t Plaintext[], uint16_t Key[], uint16_t Ciphertext[]){
    uint16_t i;
    uint16_t temp[8];
    for (i = 0; i < 8; ++i)
        temp[i] = Ciphertext[i];
