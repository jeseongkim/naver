...
void Key_XOR_64_128(uint8_t In_text[], uint8_t Key[], uint8_t Round);
void PIPO_64_128_E_C(uint8_t Plaintext[], uint8_t Key[], uint8_t Ciphertext[]);
//#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-#-
