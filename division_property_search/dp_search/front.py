# Add directory of modules into sys.path
import numpy as np; import os, sys, pickle
importfolders = ["mymodule"]
for foldername in importfolders:
    backdir = os.path.dirname(os.getcwd());	sys.path.append( os.path.abspath(backdir + '/' + foldername) )
